...
class testSphereTest {
    ...
    public void testFindIntersections() {
        ...
        assertEquals(sphere.findIntersections(beyond), "Wrong number of points");
        ...
        assertEquals(1, result.size(), "Wrong number of points");
        assertEquals(p, result, "Ray on sphere");
        ...
        result = sphere.findIntersections(r);
        assertEquals(1, result.size(), "Wrong number of points");
        assertEquals(new Point(2,0,0), result, "Ray starts at sphere and goes inside");
        // TC15: Ray starts inside (1 points)
        r = new Ray(new Point(1.5,0,0), new Vector(1,0,0));
        result = sphere.findIntersections(r);
        assertEquals(1, result.size(), "Wrong number of points");
        assertEquals(new Point(2,0,0), result, "Ray starts inside");

        // TC16: Ray starts at the center (1 points)
        r = new Ray(new Point(1,0,0), new Vector(1,0,0));
        result = sphere.findIntersections(r);
        assertEquals(1, result.size(), "Wrong number of points");
        assertEquals(new Point(2,0,0), result, "Ray starts at the center");
